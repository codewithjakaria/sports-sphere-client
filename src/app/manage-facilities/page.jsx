...
// // ইমেজ এরর হ্যান্ডল করার জন্য ছোট কম্পোনেন্ট
...
//   if (hasError || !imgSrc) {
//     return (
//       <div className="w-full h-40 bg-gray-800 rounded-xl flex items-center justify-center text-gray-500 font-bold border border-green-900/20">
//         NO IMAGE
//       </div>
//     );
//   }
...
//       src={imgSrc}
//       alt={alt}
//       className="w-full h-40 object-cover rounded-xl border border-green-900/20"
...
//   if (loading)
//     return (
//       <div className="flex justify-center mt-32 text-green-500">
...
//       <aside className="w-64 bg-black border-r border-green-900 p-6 flex flex-col gap-10">
//         <h1 className="text-2xl font-black text-green-500">SportNest</h1>
//         <nav className="space-y-4">
//           <Link
//             href="/"
//             className="flex items-center gap-3 text-gray-400 hover:text-green-400"
//           >
//             <Home size={20} /> Home
//           </Link>
//           <Link
...
//             className="flex items-center gap-3 text-gray-400 hover:text-green-400"
//           >
//             <LayoutGrid size={20} /> My Bookings
//           </Link>
//           <Link
//             href="/add-facility"
//             className="flex items-center gap-3 text-gray-400 hover:text-green-400"
...
//             className="flex items-center gap-3 font-bold text-green-500"
//           >
//             <Settings size={20} /> Manage Facilities
//           </Link>
//         </nav>
//       </aside>
...
//           <Link
//             href="/add-facility"
//             className="bg-green-600 hover:bg-green-700 px-6 py-2 rounded-xl font-bold flex items-center gap-2 transition"
//           >
...
//               <div
//                 key={f._id}
//                 className="bg-[#111111] p-4 rounded-2xl border border-green-900/30 hover:border-green-500/50 transition"
//               >
//                 <FacilityImage src={f.image} alt={f.name} />
//                 <h2 className="text-xl font-bold mt-4 text-white truncate">
//                   {f.name}
//                 </h2>
...
//                   <button className="flex-1 bg-green-900/20 hover:bg-green-600 text-green-500 hover:text-white py-2 rounded-lg transition font-bold flex items-center justify-center gap-2">
//                     <Edit2 size={16} /> Edit
//                   </button>
//                   <button
//                     onClick={() => handleDelete(f._id)}
//                     className="flex-1 bg-red-900/20 hover:bg-red-600 text-red-500 hover:text-white py-2 rounded-lg transition font-bold flex items-center justify-center gap-2"
//                   >
